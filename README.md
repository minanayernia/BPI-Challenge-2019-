...
Challenge 1: Data exploration, preprocessing, and process model discovery using process mining techniques.
Challenge 2: Throughput time analysis to measure the performance of the invoicing process.
Challenge 3: Identifying deviations from the standard process and quantifying their severity.
Data
...
Project Structure
BIS2019.ipynb: The main Jupyter notebook that contains the data preprocessing, analysis, process mining, and reporting.
Data: Directory containing the event log dataset and any additional resources used in the project.
Figures: Directory with any process models, graphs, and visualizations produced during the analysis.
Methodology
